...
-- This populates the custom_benchmarks table with the 54 core Mito Labs biomarkers
-- ============================================

-- Clear existing data (optional - uncomment if you want a fresh start)
-- TRUNCATE TABLE custom_benchmarks CASCADE;

-- Insert the 54 core biomarkers with gender-specific ranges
INSERT INTO custom_benchmarks (name, male_range, female_range, units, category, is_active) VALUES
  ...
  ('Basophils', '0-1 % (≤ 0.09 ×10³/µL)', '0-1 % (≤ 0.09 ×10³/µL)', ARRAY['%', '×10³/µL', '×10^3/µL', 'K/µL', 'K/uL'], 'White Blood Cells', true),
  ...
  ('Eosinophils', '1-4 % (0.0-0.3 ×10³/µL)', '1-4 % (0.0-0.3 ×10³/µL)', ARRAY['%', '×10³/µL', '×10^3/µL', 'K/µL', 'K/uL'], 'White Blood Cells', true),
  ...
  ('Lymphocytes', '20-40 % (1.1-3.1 ×10³/µL)', '20-40 % (1.1-3.1 ×10³/µL)', ARRAY['%', '×10³/µL', '×10^3/µL', 'K/µL', 'K/uL'], 'White Blood Cells', true),
  ...
  ('Monocytes', '2-8 % (0.3-0.5 ×10³/µL)', '2-8 % (0.3-0.5 ×10³/µL)', ARRAY['%', '×10³/µL', '×10^3/µL', 'K/µL', 'K/uL'], 'White Blood Cells', true),
  ('Neutrophils', '40-70 % (3.0-4.5 ×10³/µL)', '40-70 % (3.0-4.5 ×10³/µL)', ARRAY['%', '×10³/µL', '×10^3/µL', 'K/µL', 'K/uL'], 'White Blood Cells', true),
...
-- ✅ SEEDING COMPLETE!
-- ============================================
-- You should now see exactly 54 core biomarkers in custom_benchmarks table
-- All biomarkers have gender-specific ranges where applicable
-- ============================================
